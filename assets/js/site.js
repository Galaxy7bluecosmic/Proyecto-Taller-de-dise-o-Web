...
import { prepararCarrito, prepararPago } from "./modules/cart.js?v=4";
import { actualizarPerfil } from "./modules/profile.js";
import { iniciarMenu } from "../../JSscripts/menu/menu.js?v=4";
import { iniciarPromociones } from "../../JSscripts/promociones/promociones.js?v=4";
import { iniciarFormularioPedidos } from "../../JSscripts/form_pedidos/form_pedidos.js?v=4";
import { iniciarPedidos } from "../../JSscripts/pedidos/pedidos.js?v=4";
import { iniciarMostrarContrasena } from "../../JSscripts/auth/password.js?v=4";
